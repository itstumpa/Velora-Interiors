...
const stepIcons: Record<string, React.ReactNode> = {
  ...
  tool: (
    <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17l-5.322 5.32a2.12 2.12 0 01-3.0-3.0l5.322-5.322m3.434 5.59l5.322-5.322m0 0l3.434-3.434a2.12 2.12 0 00-3.0-3.0l-5.322 5.322M3.0 3.0l18 18" />
    </svg>
  ),
  star: (
    <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
